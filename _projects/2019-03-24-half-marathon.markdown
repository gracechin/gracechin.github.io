...
![running routine]({{site.url}}/assets/posts/half-marathon-comic-running-routine.jpg)

Capturing key moments of the day:
![snapshot moments of the day]({{site.url}}/assets/posts/half-marathon-comic-snapshot.png)
